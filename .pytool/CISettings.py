...
class Settings(CiBuildSettingsManager, UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPackagesSupported(self):
        ...
        return (["Platform/ARM/VExpressPkg"])
    ...
    def SetPackages(self, list_of_requested_packages):
        ...
        '''
        print("list_of_requested_packages")
        print(list_of_requested_packages)
        print("self.GetPackagesSupported()")
        print(self.GetPackagesSupported())
    ...
    def GetRequiredSubmodules(self):
        ...
        rs.append(RequiredSubmodule(
            "edk2/ArmPkg/Library/ArmSoftFloatLib/berkeley-softfloat-3", False))
        rs.append(RequiredSubmodule(
            "edk2/CryptoPkg/Library/OpensslLib/openssl", False))
        rs.append(RequiredSubmodule(
            "edk2/UnitTestFrameworkPkg/Library/CmockaLib/cmocka", False))
        rs.append(RequiredSubmodule(
            "edk2/MdeModulePkg/Universal/RegularExpressionDxe/oniguruma", False))
        rs.append(RequiredSubmodule(
            "edk2/MdeModulePkg/Library/BrotliCustomDecompressLib/brotli", False))
        rs.append(RequiredSubmodule(
            "edk2/BaseTools/Source/C/BrotliCompress/brotli", False))
        rs.append(RequiredSubmodule(
            "edk2/RedfishPkg/Library/JsonLib/jansson", False))
        return rs
